...
function LoginContent() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 py-12 bg-[#fcfcfc] relative overflow-hidden">
      ...
      <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} className="w-full max-w-md bg-white rounded-[3rem] shadow-[0_20px_50px_rgba(0,0,77,0.06)] border border-gray-50 p-12 relative z-10">
        <div className="mb-8">
        ...
        <form className="space-y-6" onSubmit={handleLogin}>
          <div className="space-y-2">
            ...
            <div className="relative group">
              ...
              <input required type="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="admin@easyjobs.pk" className="w-full pl-14 pr-6 py-4 bg-slate-50 border-2 border-transparent focus:border-[#00004d] focus:bg-white rounded-full outline-none font-bold text-[#00004d] transition-all" />
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative group">
              ...
              <input required type={showPassword ? "text" : "password"} value={password} onChange={(e) => setPassword(e.target.value)} placeholder="••••••••" className="w-full pl-14 pr-14 py-4 bg-slate-50 border-2 border-transparent focus:border-[#00004d] focus:bg-white rounded-full outline-none font-bold text-[#00004d] transition-all" />
          ...
          <button type="submit" disabled={loading} className="w-full py-5 rounded-full font-black text-xs tracking-[0.2em] bg-[#00004d] text-white hover:bg-[#00004d]/90 shadow-xl shadow-blue-900/10 flex items-center justify-center gap-3 active:scale-95 transition-all">
